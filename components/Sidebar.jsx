          ...
          <div className="flex max-md:flex-col-reverse items-center justify-between w-full h-full ">
            <div className=" w-full h-full flex flex-col max-md:mt-2 justify-between  md:justify-around text-[9px] sm:text-[11px] md:text-xs lg:text-sm 2xl:text-xl 2xl:pb-4 max-sm:tracking-[0.2em]">
              ...
              <div className=" flex md:gap-4 lg:gap-0 items-center">
                <div className="w-[48px] sm:w-[55px] lg:w-[65px] 2xl:w-[80px]">
                  <CountryFlag />
                </div>
              ...
              <div className=" flex md:gap-4 lg:gap-0 items-center">
                <div className="w-[48px] sm:w-[55px] lg:w-[65px] 2xl:w-[80px]"></div>
                <div className="grid grid-cols-2 gap-[2px] md:gap-1 2xl:gap-4 gap-x-6 md:gap-x-10 2xl:gap-x-20">
                  <div className="opacity-50  w-[120px] sm:w-[126px] md:w-[150px] lg:w-[250px] 2xl:w-[270px]">
                    DATE
                  </div>
            ...
            <div className=" flex max-md:justify-center max-md:items-center flex-col max-md:my-4 max-md:mb-8 gap-4 lg:gap-8 2xl:gap-10 items-end w-full ">
              <div id="download">
                <div className="flex max-md:flex-col max-md:justify-center md:items-center leading-none">
                  ...
                  <p className=" md:hidden block text-center  pb-1 text-xs md:text-sm lg:text-lg 2xl:text-xl md:mt-2">
                    download
                  </p>
                  <div className=" flex max-md:flex-row-reverse max-md:justify-center md:flex-col gap-2 2xl:gap-8 lx:mt-2 2xl:mt-4 items-center">
                    <p className=" normal-case text-[32px] md:text-[15px] lg:tex-[20px] 2xl:text-[26px]">
                      Mbps
                    </p>
                    <img
              ...
              <div id="upload">
                <div className="flex max-md:flex-col max-md:justify-center md:items-center leading-none">
                  ...
                  <p className=" md:hidden block text-center text-[9px] pb-1 text-xs md:text-sm lg:text-lg 2xl:text-xl md:mt-2">
                    upload
                  </p>
                  <div className=" flex max-md:flex-row-reverse max-md:justify-center md:flex-col gap-2 2xl:gap-8 lx:mt-2 2xl:mt-4 items-center">
                    <p className=" normal-case text-[32px] md:text-[15px] lg:tex-[20px] 2xl:text-[26px]">
